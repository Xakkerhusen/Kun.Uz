...
public class RegionController {
    ...
    public ResponseEntity<?> update(@PathVariable("id") Integer id,
        ...
        return ResponseEntity.ok(regionService.update(id,region,language));
    }
    ...
    public ResponseEntity<?> delete(@PathVariable("id") Integer id,
        ...
        return ResponseEntity.ok(regionService.delete(id,language));
    }
    ...
    public ResponseEntity<List<Region>> getAllByLang(@RequestHeader(value = "Accept-Language",defaultValue = "UZ")Language language) {
